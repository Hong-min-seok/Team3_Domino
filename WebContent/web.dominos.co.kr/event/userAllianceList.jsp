			...
			<div class="inner-box">
				<div class="page-title-wrap">
					...
					<div class="depth-area">
						<ol>
							...
							<li><a href="./UserAllianceList.bo">이벤트&middot;제휴</a></li>
				...
				<article class="menu-list-area">
					<div class="menu-nav-wrap">
						<div class="menu-nav">
							<ul>
								<li><a href="./UserEventList.bo">이벤트</a></li>
						...
						<div class="menu-list">
							<ul id="addUl">
								...
								<% for(int i=0; i<alliancelist.size(); i++) { 
									...
									<li>
									<div class="prd-img">
										<a href="UserAllianceDetail.bo?list_num=<%=bean.getList_num()%>">
