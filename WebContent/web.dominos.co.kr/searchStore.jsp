...
<meta property="al:ios:url" content="https://itunes.apple.com/kr/app/id371008429" /><link rel="shortcut icon" href="https://cdn.dominos.co.kr/renewal2018/w/img/favicon.ico"/>
	...
	<script type="text/javascript" src="https://web.dominos.co.kr/cdn.dominos.co.kr/renewal2018/w/js/jquery.flexslider.js"></script>
   ...
   <div id = "pizzaAddForm" align="center">
      <h1 class="page-title" style="font-size: 36px; padding: 50px;">매장찾기</h1>
         ...
         <table style="margin-bottom: 30px">
            <tr>
               <form method="post" action="./searchStoreResult.jsp" >
                  <!-- <script>
                  function input_Text(){storeName=document.getElementById("branch_name").value;}
                  </script> -->
               <td colspan="3"><input type="text" name="storeName" placeholder="매장명을 검색하세요."><input type="submit" value="검색">
