	...
	clear: both;
		...
		<div id="container">
    		...
    		<div align="center">
    			...
    			<form action="./AdminEventWriteAction.bo" method="post"
    				enctype="multipart/form-data" name="eventform" id="eventform">
    			...
    			<table style="width: 80%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td style="width: 90%">
							<input name="event_title" type="text" size="50" maxlength="100" value=""/>
						</td>
					</tr>
					<tr>
						...
						<td>
							<textarea name="event_bulletin" cols="67" rows="30" style="height: 500px"></textarea>
						</td>
					</tr>
					<tr>
      					...
      					<td>
         					<input name="event_file" type="file"/>
      					</td>
   					</tr>
					<tr align="center" valign="middle">
      					<td colspan="2">
         					<a href="javascript:addevent()">[등록]</a>&nbsp;&nbsp;
