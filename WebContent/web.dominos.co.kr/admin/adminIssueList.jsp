...
ul.menu:after {
	...
	clear: both;
		...
		<% List issuelist = (ArrayList)request.getAttribute("issuelist"); %>
    			...
    			<table style="width: 80%" cellpadding="0" cellspacing="0">
					...
					<%
						for(int i=0;i<issuelist.size();i++){
							IssueBean bean=(IssueBean)issuelist.get(i);
					%>
						<tr align="center" valign="middle" bordercolor="#333333"
							...
							<td style="font-family:Tahoma;font-size:10pt;">
								<div align="left">
									<a href="./AdminIssueDetail.bo?num=<%=bean.getList_num()%>">
										<b> ▶ <%=bean.getTitle()%></b>
									</a>
								</div>
							</td>
					...
					<tr align="right" style="border-top: 2px solid black;">
						<td></td>
						<td>
	   						<a href="./AdminIssueWriteView.bo">[글쓰기]</a>
						</td>
					</tr>
				</table>
			</div>
