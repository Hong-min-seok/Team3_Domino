				...
				<div class="page-title-wrap">
					...
					<div class="depth-area">
						<ol>
							...
							<li><a href="./AdminAllianceList.bo">이벤트&middot;제휴</a></li>
					...
					<div class="menu-nav-wrap">
						<div class="menu-nav">
							<ul>
								...
								<li ><a href="./AdminAllianceList.bo">제휴이벤트</a></li>
						...
						<div class="menu-list">
							<ul id="addUl">
								...
								<% for(int i=0; i<eventlist.size(); i++) { 
									EventBean bean = (EventBean)eventlist.get(i); %>
									<li>
									<div class="prd-img">
										<a href="AdminEventDetail.bo?list_num=<%=bean.getList_num()%>">
								...
								<div align="right">
									<a href="./AdminEventWriteView.bo">제휴 이벤트 등록</a>
								</div>
						</div>
					</div>
