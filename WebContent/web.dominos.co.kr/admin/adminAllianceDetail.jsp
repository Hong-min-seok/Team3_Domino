...
ul.menu:after {
	...
	clear: both;
		...
		<% AllianceBean bean = (AllianceBean)request.getAttribute("alliancebean");%>
		...
		<div id="container">
    		...
    		<div align="center">
    			<h1 class="page-title" style="font-size: 36px; width: 80%; text-align: left; padding: 50px">이벤트</h1>
    			...
    			<table style="width: 80%" cellpadding="0" cellspacing="0">
    					...
    					<td>
    						<% if(bean.getAdd_file() != null) {%>
    							<div style="padding: 20px">
    								<img src="../../eventupload/<%=bean.getAdd_file() %> ">
    							</div>
    						<%}%>
    						<%=bean.getBulletin() %>	
    					</td>
    				...
    				<tr align="center" valign="middle">
      					<td>
         					<a href="./AdminAllianceDeleteAction.bo?list_num=<%=bean.getList_num()%>">[삭제]</a>&nbsp;&nbsp;
