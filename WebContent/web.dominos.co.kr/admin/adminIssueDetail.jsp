...
ul.menu:after {
	...
	clear: both;
		...
		<% IssueBean bean = (IssueBean)request.getAttribute("issuebean");%>
    		...
    		<div align="center">
    			...
    			<table style="width: 80%" cellpadding="0" cellspacing="0">
    					...
    					<td>
    						<% if(bean.getAdd_file() != null) {%>
    							<div style="padding: 20px">
    								<img src="../../issueupload/<%=bean.getAdd_file() %> ">
    							</div>
    						<%}%>
    						<%=bean.getBulletin() %>	
    					</td>
    				...
    				<tr align="center" valign="middle">
      					<td>
         					<a href="./AdminIssueDeleteAction.bo?list_num=<%=bean.getList_num()%>">[삭제]</a>&nbsp;&nbsp;
