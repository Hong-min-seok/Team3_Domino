...
ul.menu:after {
	...
	clear: both;
		...
		<div id="container">
    		...
    		<div align="center">
    			<h1 class="page-title" style="font-size: 36px; width: 80%; text-align: left; padding: 50px">이벤트 등록</h1>
    			<hr/ style="width: 80%; border-left-width: thick;">
    			
    			<form action="./AdminAllianceWriteAction.bo" method="post"
    				enctype="multipart/form-data" name="allianceform" id="allianceform">
    			...
    			<table style="width: 80%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td style="width: 90%">
							<input name="alliance_title" type="text" size="50" maxlength="100" value=""/>
						</td>
					</tr>
					<tr>
						...
						<td>
							<textarea name="alliance_bulletin" cols="67" rows="30" style="height: 500px"></textarea>
						</td>
					</tr>
					<tr>
      					...
      					<td>
         					<input name="alliance_file" type="file"/>
      					</td>
   					</tr>
					<tr align="center" valign="middle">
      					<td colspan="2">
         					<a href="javascript:addalliance()">[등록]</a>&nbsp;&nbsp;
