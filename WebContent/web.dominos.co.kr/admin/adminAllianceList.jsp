		...
		<div class="sub-type menu">
			<div class="inner-box">
				<div class="page-title-wrap">
					<h2 class="page-title">이벤트&middot;제휴</h2>
					<div class="depth-area">
						<ol>
							<li><a href="../main.html">홈</a></li>
							<li><a href="AdminEventList.bo">이벤트&middot;제휴</a></li>
							<li><strong>제휴이벤트</strong></li>
						</ol>
					</div>
				</div>
				<article class="menu-list-area">
					<div class="menu-nav-wrap">
						<div class="menu-nav">
							<ul>
								<li ><a href="AdminEventList.bo">이벤트</a></li>
								<li class="active"><a href="#">제휴이벤트</a></li>
								<li><a href="discount.html">할인안내</a></li>
							</ul>
						</div>
					</div>
					<!--2020-04-20 추가 (s)-->
                    ...
                    <!--2020-04-20 추가 (e)-->
                    <% List alliancelist = (List)request.getAttribute("alliancelist"); %>
					<div class="best-set-menu">
						<div class="menu-list">
							<ul id="addUl">
							
								<% for(int i=0; i<alliancelist.size(); i++) { 
									AllianceBean bean = (AllianceBean)alliancelist.get(i); %>
									<li>
									<div class="prd-img">
										<a href="AdminAllianceDetail.bo?list_num=<%=bean.getList_num()%>">
											<img src="../../eventupload/<%=bean.getAdd_file() %>" class="lazyload"/>
											</a>
										</div>
									</li>
									<%} %>
								...
								<div align="right">
									<a href="./AdminAllianceWriteView.bo">이벤트 등록</a>
								</div>
						</div>
					</div>
